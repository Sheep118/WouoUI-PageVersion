...
//------------------与title页面相关的默认参数
#define DEFAULT_TILE_B_TITLE_FNOT ZLabsBitmap_12px_CN_12x24_t // 磁贴大标题字体
...
//------------------与list页面相关的默认参数
#define DEFAULT_LIST_TEXT_FONT ZLabsBitmap_12px_CN_6x12_t // 列表文字的字体
...
#define DEFAULT_LIST_LINETAIL_TXT_PREFIX                                                           \
    "><" // listtext中使用这些字符其中一个，行尾会把content显示出来
#define DEFAULT_LIST_LINETAIL_SPIN_PREFIX                                                          \
...
#define DEFAULT_WAVE_DEPTH                                                                         \
    (WOUOUI_BUFF_WIDTH - DEFAULT_WAVE_Y_AXIS_LABEL_WIDTH + 100) // 默认波形的储存深度
